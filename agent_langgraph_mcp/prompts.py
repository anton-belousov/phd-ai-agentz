...
FIRST_PROMPT = """Analyze this host for security or network problems: {host}
...
ANALYSIS_PROMPT = """Analyze scan results for the host {host} and determine its network configuration, security details, and other useful information."""
